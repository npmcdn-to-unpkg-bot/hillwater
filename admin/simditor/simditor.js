  ...
  ImageButton.prototype.renderMenu = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input name="img" type="file" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadItem);
      };
    })(this);
    createInput();
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input name="img" type="file" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadBtn);
      };
    })(this);
    createInput();
